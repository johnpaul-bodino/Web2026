...
<body>
	<form class="" action="bodinoInsert.php" method="POST" autocomplete="ON">
		...
		<!-- Phone Number -->
		<tr>
		<td> <label for="bodinoPnumber"> Phone Number </label>  </td>
		<td> <input type="number" id="bodino_Pnumber" name ="bodino_Pnumber" required value =""></td>
		<td></td>
		</tr>
		...
		<tr> 
		<td></td>
		<td> <input type="number" id="bodino_Zipcode" name ="bodino_Zipcode" required value =""></td>
		...
		<button type="submit" name="bodinoRegister" class="bodinoRegister"> REGISTER </button>
		</a>
		<a href=" ">
		<button type="reset" class="bodinoClear">CLEAR</button>
		</a>
		</h2>
	</form>
</body>
